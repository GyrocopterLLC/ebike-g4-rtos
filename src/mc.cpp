...
void DAC_Task(void* pvParameters) {
	...
	while(true) {
		...
		adc_get_scaled_voltages(&voltages);
		...
		if(debug_usb_send) {
			...
			if(dac_task_counter % 40 == 0) { // once per 2 milliseconds
				...
				/*
				 * Do this count at the end, after we know what the size is!
				usb_packet_buffer[1] =
				...
				*/
				packet_pointer = 2;
				buffer_append(usb_packet_buffer, packet_pointer, &dac_task_counter);
				buffer_append(usb_packet_buffer, packet_pointer, &anglef);
				buffer_append(usb_packet_buffer, packet_pointer, &hall_state);
				buffer_append(usb_packet_buffer, packet_pointer, &throttle_angle);
				buffer_append(usb_packet_buffer, packet_pointer, &svm.tA);
				buffer_append(usb_packet_buffer, packet_pointer, &svm.tB);
				buffer_append(usb_packet_buffer, packet_pointer, &svm.tC);
				buffer_append(usb_packet_buffer, packet_pointer, &currents.iA);
				buffer_append(usb_packet_buffer, packet_pointer, &currents.iB);
				buffer_append(usb_packet_buffer, packet_pointer, &currents.iC);
				buffer_append(usb_packet_buffer, packet_pointer, &voltages.vA);
				buffer_append(usb_packet_buffer, packet_pointer, &voltages.vB);
				buffer_append(usb_packet_buffer, packet_pointer, &voltages.vC);
				buffer_append(usb_packet_buffer, packet_pointer, &voltages.vBus);
				//buffer_append(usb_packet_buffer, packet_pointer, &);
